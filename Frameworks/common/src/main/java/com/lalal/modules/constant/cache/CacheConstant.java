...
//        Objects.requireNonNull(toStation, "toStation must not be null");
    ...
    public static final String STATION_DISTANCE_KEY_TEMPLATE = "FARE::DISTANCE::%s";
     ...
     * @return 缓存Key字符串
     */
    public static String stationDistanceKey(Long trainId) {
        Objects.requireNonNull(trainId, "trainId must not be null");
        return String.format(STATION_DISTANCE_KEY_TEMPLATE, trainId);
    }

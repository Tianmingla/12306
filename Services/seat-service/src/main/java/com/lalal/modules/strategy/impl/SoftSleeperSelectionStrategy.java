...
@Component
public class SoftSleeperSelectionStrategy extends AbstractSeatSelectionStrategy {

    public SoftSleeperSelectionStrategy(StringRedisTemplate redisTemplate, 
    ...
    protected SeatLayout getLayout() {
        return SeatLayout.SOFT_SLEEPER;
    }

    @Override
    public int getSeatType() {
        return SeatType.SOFT_SLEEPER.getCode();
    }
}

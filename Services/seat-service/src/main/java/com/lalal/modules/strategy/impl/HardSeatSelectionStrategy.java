...
@Component
public class HardSeatSelectionStrategy extends AbstractSeatSelectionStrategy {

    public HardSeatSelectionStrategy(StringRedisTemplate redisTemplate, 
    ...
    protected SeatLayout getLayout() {
        return SeatLayout.HARD_SEAT;
    }

    @Override
    public int getSeatType() {
        return SeatType.HARD_SEAT.getCode();
    }
}
